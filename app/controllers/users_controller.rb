       ...
       if params[:device_type] == 'wp'
           if params[:wp_notification_url] != ''
            @update = User.where('id= ?', user.id).update_all(lat: params[:lat], lan: params[:lan], device_type: params[:device_type], device_token: params[:device_token], wp_notification_url: params[:wp_notification_url])
              if(@update == 1)
                return render :json => {:success => true, :id => user.id, :email => user.email, :lat => params[:lat], :lan => params[:lan], :company_id => user.company_id, :user_info => user}
              else
...
def setting
  if params[:user_id] != '' and params[:user_id] != nil and params[:email] == ''
    ...
    elsif(params[:user_id] and params[:user_id] != '' and params[:email] and params[:email] !='' and params[:password] and params[:password] !='' and params[:FirstName] and params[:FirstName] !='' and params[:LastName] and params[:LastName] !='' and params[:EobrNumber] and params[:EobrNumber] !='' and params[:eobr_make_id] and params[:eobr_make_id] !='' and params[:eobr_model_id] !='' and params[:TruckNumber] and params[:TruckNumber] !='' and params[:TruckModel] and params[:TruckModel] !='' and params[:truckmake] and params[:truckmake] !='' and params[:TruckYear] and params[:TruckYear] and params[:TruckYear] !='' and params[:TruckOwner] and params[:TruckOwner] !='' and params[:company_id] and params[:company_id] !='' and params[:tech_support] and params[:tech_support] !='' and params[:Contact] and params[:Contact] !='' and params[:device_type] and params[:device_type] !='' and params[:device_type] =="iphone" and params[:device_token] !='' and params[:Language] and params[:Language] != '')
