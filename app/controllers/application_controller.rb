class ApplicationController < ActionController::Base
  ...
  def configure_permitted_parameters
    devise_parameter_sanitizer.for(:sign_up) { |u| u.permit(:email, :password, :FirstName, :LastName, :EobrNumber, :eobr_make_id, :eobr_model_id, :TruckNumber, :TruckMake, :TruckYear, :TruckOwner, :company_id , :Language, :tech_support_id, :Contact,:device_type,:device_token,:lat,:lan,:Role) }
  end
