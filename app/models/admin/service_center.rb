class Admin::ServiceCenter < ActiveRecord::Base
	...
	validates :lat, presence: true, numericality: {only_float: true, message: "is not a valid latitude"}
	validates :lan, presence: true, numericality: {only_float: true, message: "is not a valid longnitude"}
