...
class AdminEobrMakesControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create admin_eobr_make" do
    assert_difference('AdminEobrMake.count') do
      post :create, admin_eobr_make: {  }
    end
  ...
  test "should update admin_eobr_make" do
    patch :update, id: @admin_eobr_make, admin_eobr_make: {  }
    assert_redirected_to admin_eobr_make_path(assigns(:admin_eobr_make))
  end

  test "should destroy admin_eobr_make" do
    assert_difference('AdminEobrMake.count', -1) do
