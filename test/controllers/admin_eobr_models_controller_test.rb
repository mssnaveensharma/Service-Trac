...
class AdminEobrModelsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should create admin_eobr_model" do
    assert_difference('AdminEobrModel.count') do
      post :create, admin_eobr_model: {  }
    end
  ...
  test "should update admin_eobr_model" do
    patch :update, id: @admin_eobr_model, admin_eobr_model: {  }
    assert_redirected_to admin_eobr_model_path(assigns(:admin_eobr_model))
  end

  test "should destroy admin_eobr_model" do
    assert_difference('AdminEobrModel.count', -1) do
