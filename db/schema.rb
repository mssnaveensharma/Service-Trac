...
ActiveRecord::Schema.define(version: 20140813063438) do
  ...
  create_table "admin_service_centers", force: true do |t|
    ...
    t.text     "WorkingHours"
    t.integer  "trailer_access"
    t.integer  "appointment_service"
    t.integer  "appointment_installation"
  end
  ...
  create_table "alert_notes", force: true do |t|
    t.integer  "user_id"
    t.integer  "alert_id"
